module.exports = function(grunt) {
    ...
    var testRunners = root + '/taoEventLog/views/js/test/**/test.html';
    var testFiles = root + '/taoEventLog/views/js/test/**/test.js';
    ...
    // bundle task
    grunt.registerTask('taoeventlogtest', ['qunit:taoeventlog']);
};
