...
,"i18n","helpers","ui/datatable","tpl!taoEventLog/controller/TaoEventLog/show/layout","taoEventLog/components/export/modalExporter","ui/dateRange"],function($,__,helpers,datatable,layoutTpl,exporter,dateRangeFactory){"use strict";var listUrl=helpers._url("search","TaoEventLog","taoEventLog");return{start:function(){var data={dataTypes:[{key:"event_name",title:__("Event Name")},{key:"action",title:__("Action")},{key:"user_id",title:__("User ID")},{key:"user_roles",title:__("User Roles")},{key:"occurred",title:__("Occurred")},{key:"properties",title:__("Properties")}]},$layout=$(layoutTpl(data)),$eventFilter=$(".log-browser .log-table-filters",$layout),
$eventList=$(".log-browser .log-table",$layout),$eventViewer=$(".event-viewer",$layout),$exportLink=$(".js-export",$layout),$filterRange=dateRangeFactory({pickerType:"datetimepicker",renderTo:$eventFilter,pickerConfig:{dateFormat:"yy-mm-dd",timeFormat:"HH:mm:ss"}}),currentFilter={filtercolumns:{}};$filterRange.on("submit",function(){$eventList.datatable("options",{params:{periodStart:$filterRange.getStart(),periodEnd:$filterRange.getEnd()}}),$eventList.datatable("refresh")}),$exportLink.on("click",function(){currentFilter.filtercolumns=_.merge(currentFilter.filtercolumns,{from:$filterRange.getStart(),to:$filterRange.getEnd()}),exporter({title:__(
"Export Log Entries"),exportUrl:helpers._url("export","TaoEventLog","taoEventLog",currentFilter)})}),$(".content").append($layout),$eventList.datatable({url:listUrl,sortby:"occurred",sortorder:"desc",filter:!0,rowSelection:!0,filterStrategy:"multiple",model:[{id:"identifier",label:__("ID"),transform:function(id,row){return row.raw.id}},{id:"event_name",label:__("Event Name"),sortable:!0,filterable:!0},{id:"action",label:__("Action"),sortable:!0,filterable:!0},{id:"user_id",label:__("User ID"),sortable:!0,filterable:!0},{id:"user_roles",label:__("User Roles"),sortable:!0,filterable:!0,transform:function(roles){return roles.split(", ").shift()}},{
id:"occurred",label:__("Occurred"),sortable:!0}],listeners:{selected:function(e,event){!function(event){var key,json,str;for(key in event)event.hasOwnProperty(key)&&("properties"===key?(null!==(json=JSON.parse(event[key]))&&"object"!=typeof json&&(json=JSON.parse(json)),str=JSON.stringify(json,void 0,2),$("."+key,$eventViewer).html("<pre>"+str+"</pre>")):"user_roles"===key?$("."+key,$eventViewer).html(event.user_roles.split(",").join("<br>")):$("."+key,$eventViewer).html(event[key]))}(event.raw),$eventViewer.removeClass("hidden")},filter:function(e,options){options.page=1},query:function(e,ajaxConfig){currentFilter=_.pick(ajaxConfig&&ajaxConfig.data,[
"filterquery","filtercolumns","sortby","sortorder","sorttype"])}}})}}}),define("taoEventLog/loader/taoEventLog.bundle",function(){});
